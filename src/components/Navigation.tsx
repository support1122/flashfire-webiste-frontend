...
//            <div className='flex items-center justify-center py-1.5 sm:py-2.5 space-x-0.5 sm:space-x-3 lg:space-x-6 text-nowrap'>
...
const Navigation = () => {
  ...
  const openSignupModal = (step) => {
    const modal = document.getElementById('signup-modal');
    if (modal) modal.classList.remove('hidden');
    // You can pass the step logic here if needed
    setIsMenuOpen(false);
  };
  ...
  return (
    <div className="font-inter">
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        ...
        {/* Enhanced Consultation Banner - Responsive Fix */}
        <div className='w-full bg-gradient-to-r from-orange-500 to-orange-600 shadow-lg'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='flex flex-col sm:flex-row items-center justify-center py-2 sm:py-2.5 text-center sm:text-left space-y-2 sm:space-y-0 sm:space-x-4 lg:space-x-6'>
              ...
              <div className='flex items-center justify-center space-x-2'>
                <img
                  src='https://res.cloudinary.com/drit9nkha/image/upload/v1753417509/right-arrow_j7m7o3.webp'
                  alt='Arrow'
                  className='w-4 h-4 filter brightness-0 invert flex-shrink-0'
                />
              ...
              <button
                onClick={() => openSignupModal(2)}
                className='bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded font-bold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 text-sm tracking-wide mx-auto sm:mx-0'
              >
                Book Now
              </button>
