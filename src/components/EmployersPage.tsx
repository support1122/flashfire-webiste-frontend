...
import { Building, Mail, Phone, Users, MapPin, Briefcase, DollarSign, Calendar, Loader } from 'lucide-react';
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl max-w-2xl w-full p-8 shadow-lg">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 py-8">
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="mb-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Partner with FlashFire</h1>
            <p className="text-xl text-gray-600">Find top talent faster with our AI-powered recruitment platform</p>
          </div>
        </div>
